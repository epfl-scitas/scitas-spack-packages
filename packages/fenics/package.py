...
class Fenics(CMakePackage):
    ...
    depends_on("hdf5@:1.10+hl+fortran", when="@:2018.9+hdf5+petsc")
    depends_on("hdf5@:1.10+hl", when="@:2018.9+hdf5~petsc")
    depends_on("hdf5+hl+fortran", when="@2019.0:+hdf5+petsc")
    depends_on("hdf5+hl", when="@2019.0:+hdf5~petsc")
    ...
    patch('hdf5-1.12.patch', when='^hdf5@1.11:')
