...
class Cudnn(Package):
    ...
    # cuDNN 7.6.0
    version('7.6.0.64-10.0-linux-x64',
            sha256='c4e1ee4168f4cadabaa989487a47bed09f34d34e35398b6084a2699d11bd2560')
    ...
    # cuDNN 7.4.2
    version('7.4.2.24-10.0-linux-x64',
            sha256='2edfc86a02b50d17e88c478955a332e6a1e8174e7e53a3458b4ea51faf02daa3')
    ...
    depends_on('cuda@10.0.0:10.0.999', when='@7.6.0.64-10.0-linux-x64')
    ...
    depends_on('cuda@10.0.0:10.0.999', when='@7.4.2.24-10.0-linux-x64')
