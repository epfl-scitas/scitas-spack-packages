...
class PyMacs2(PythonPackage):
    ...
    pypi = "MACS3/MACS3-3.0.0a7.tar.gz"

    # https://files.pythonhosted.org/packages/source/M/MACS3/MACS3-3.0.0a7.tar.gz
    
    version('3.0.0a7',        sha256='ec32d75a27d57618be068fc4dcbebbd879ce14721fd6411d9c1b8993ac906758')
