...
class IntelOneapiCompilersClassic(Package):
    ...
    def setup_run_environment(self, env):
        ...
        bin_prefix = join_path(oneapi_pkg.component_path, 'linux', 'bin', 'intel64')
        env.set("CC", join_path(bin_prefix, 'icc'))
        env.set("CXX", join_path(bin_prefix, 'icpc'))
        env.set("F77", join_path(bin_prefix, 'ifort'))
        env.set("FC", join_path(bin_prefix, 'ifort'))
