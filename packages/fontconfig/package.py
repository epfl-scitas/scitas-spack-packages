...
class Fontconfig(AutotoolsPackage):
    ...
    version('2.12.6', sha256='ffc3cbf6dd9fcd516ee42f48306a715e66698b238933d6fa7cef02ea8b3b818e')
    version('2.12.3', sha256='ffc3cbf6dd9fcd516ee42f48306a715e66698b238933d6fa7cef02ea8b3b818e')
    version('2.12.2', sha256='64d9967c58c845901d6a4c08f134dd6c828dd56fb4b9efbe058a1962f2f4b133')
    ...
    depends_on('freetype')
    depends_on('gperf', type='build', when='@2.12.1:')
    depends_on('libxml2')
    depends_on('pkgconfig', type='build')
    depends_on('font-util')
    depends_on('libuuid', when='@2.13.0:')
    ...
    def configure_args(self):
        ...
        if self.spec.satisfies('gperf'):
            args.append('GPERF={}'.format(
                join_path(self.spec['gperf'].prefix.bin, 'gperf')))
